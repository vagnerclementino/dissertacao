...
que ele pode ser corrigido, melhorado ou adaptado para mudanças ambientais
\cite{{159342}}.
...
falhas latentes antes que elas se manifestem como falhas. A Manutenção
Perfectiva fornece melhorias na documentação, desempenho e
manutenibilidade e outros atributos do sistema. A Manutenção Preventiva se preocupa com atividades
...
software. Dentre elas podemos destacar as leis da Mudança Contínua (Continuing
Change) e da Complexidade Crescente (Increasing complexity). Segundo a lei da
Mudança Contínua declara que um programa que é utilizado em um
...
sido largamente validadas, especialmente aquelas relacionadas a tamanho e
complexidade, e demostram que o processo de manutenção de software deve ter no
mínimo o mesmo nível de importância que os de projeto e execução. Em um
trabalho recente Yu \& Mishra \cite{{yu2013empirical}} examinam e avaliam de forma empírica
as Leis de Lehman com relação a evolução da qualidade do software.
