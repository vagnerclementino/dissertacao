...
atividades relacionadas ao processo de manutenção
\cite{April200973}, \cite{930170} e \cite{5741246} mediante a proposição
de modelos. Nesta mesma linha alguns estudo possuem o foco na melhoria da
produtividade do desenvolvedor mediante a remoção de Requisições de Mudança - Modification Request (MR) ou ainda a sugestão de MR's similares que possibilitam a redução da mudança de contexto (context switch).
