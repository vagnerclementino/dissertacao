...
A \textit{Manutenção} pode ser definida como o processo de modificar um componente ou um
sistema de software após a sua entrega a fim de corrigir falhas, melhorar desempenho ou outro atributo, ou adaptá-lo para mudanças ambientais
\cite{{159342}}. De outra forma, a \textit{Manutenibilidade} é a propriedade de um
sistema ou componente de software com relação ao grau de \textit{facilidade}
que ele pode ser corrigido, melhorado ou adaptado \cite{{159342}}.
...
descritos anteriormente e agrupa-os em termo único denominado \textit{Requisição de Mudança - Modification Request (MR)}, conforme a Figura \ref{fig:modification-request}
...
estudos Lehman et al. propõe um conjunto de leis da evolução do software. Dentre elas podemos destacar as leis da Mudança Contínua (Continuing
...
resultados dão suporte as Leis de Lehman especialmente a lei sobre a qualidade
do software que declara que um produto de software decresce a sua qualidade ao
