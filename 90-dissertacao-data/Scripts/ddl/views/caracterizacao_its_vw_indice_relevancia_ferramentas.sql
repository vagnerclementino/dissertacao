CREATE OR REPLACE VIEW caracterizacao_its.vw_indice_relevancia_ferramentas as 
(
select vw2.nome_ferramenta,
	    SUM(vw2.pontuacao) as indice_relevancia_ferramenta
...
order by  SUM(vw2.pontuacao) desc
)