...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.5\linewidth]{../img/grafico_melhorias_fgrm_probabilidade_recomentacao.pdf}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.9\linewidth]{../img/grafico_melhorias_fgrm_funcionalidades_faltantes.eps}
...
\begin{frame}{Sugestões de Melhorias}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=1.1\linewidth]{../img/plot_likert_avaliacao_sug_melhorias.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=1.1\linewidth]{../img/plot_likert_avaliacao_implementacao_melhorias.pdf}
