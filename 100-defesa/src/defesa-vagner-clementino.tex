...
\begin{frame}{[Atividades] Sugestões de Melhorias}
    ...
    \begin{itemize}
        ...
        \item Propostas melhorias nomeadas como Sugestão \#1
              até Sugestão \#8.

        \item Avaliadas com um levantamento com profissionais que contribuem em
...
\begin{frame}{[Resultados] Mapeamento Sistemático da Literatura}
    ...
    \begin{figure}[tb] \centering
        \makebox[\textwidth]{\includegraphics[width=.85\paperwidth]{../img/diagrama-esquema-dimensoes-melhorias.eps}}
...
\begin{tabular}{@{}ll@{}}
\toprule
\textbf{Nível de Satisfação} & \textbf{Total} \\ \midrule
OK & 32 \\
Satisfeito & 21 \\
Muito Satisfeito & 11 \\
Desapontado & 6 \\
Muito Desapontado & 2 \\ \bottomrule
\end{tabular}%
}
\caption{Nível de satisfação com as Ferramentas}
\label{tab:grafico_melhorias_fgrm_nivel_satisfacao}
\end{table}
...
\begin{tabular}{@{}lc@{}}
\toprule
\textbf{Funcionalidade} & \textbf{Total} \\ \midrule
...
RM’s trabalhadas anteriormente & 1 \\ \bottomrule
\end{tabular}%
}
