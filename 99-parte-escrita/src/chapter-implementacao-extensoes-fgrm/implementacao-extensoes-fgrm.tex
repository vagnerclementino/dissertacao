...
deveriam estar no relato de uma RM\@: \textit{(i)} a sequência de ações
...
(stack traces) que são arquivos com os históricos de chamada de métodos (logs)
que ocorreram antes do aparecimento do erro.
...
de legibilidade são fórmulados para avaliar a legibilidade do texto, geralmente
...
(survey) através questionário com profissionais que contribuem em projetos de
...
proposta. Como este perfil é bastante genérico, optamos por utilizar uma
amostra de conveniência através dos que atuam como \textit{contribuidores} em
...
spring-framework & 14575 & 12 & 106 & 211 & 295 \\ \bottomrule
\end{tabular}%
}
...
partes. Na primeira o objetivo é que o participante emita opinião sobre a
qualidade do relato de uma issue do projeto que contribui bem como do grau de
relevância do comentários gerado pela extensão. Com este objetivo nós desenhamos
um processo de avaliação conforme descrito a seguir. A descrição toma como base
um único projeto, contudo, a mesma metodologia foi replicada para os demais.
