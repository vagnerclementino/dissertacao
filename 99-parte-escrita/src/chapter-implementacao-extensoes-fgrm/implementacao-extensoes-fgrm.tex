...
\toprule
\multicolumn{1}{c}{\textbf{Projeto}} & \textbf{Média} & \textbf{Mediana} & \textbf{Desvio Padrão} & \textbf{Min} & \textbf{Max} \\ \midrule
Todos & 1,91 & 1 & 2,93 & 0 & 31 \\
vagnerclementino/spring-framework & 2,36 & 1 & 4,13 & 1 & 31 \\
vagnerclementino/guava & 1,71 & 1 & 1,9 & 0 & 16 \\
vagnerclementino/elasticsearch & 1,66 & 1 & 2,24 & 0 & 16 \\ \bottomrule
\end{tabular}%
}
\caption{My caption}
\label{my-label}
...
vagnerclementino/elasticsearch & 2,95 & 3 & 0,85 & 1 & 5 \\
vagnerclementino/guava & 3,16 & 3 & 0,88 & 2 & 5 \\
vagnerclementino/spring-framework & 3,68 & 4 & 1,01 & 1 & 5 \\ \bottomrule
\end{tabular}%
}
\caption{My caption}
\label{my-label}
