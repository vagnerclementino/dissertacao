...
\todo[inline]{O objetivo de seção é introduzir ao leitor na disciplina de
	Engenharia de Software, em especial quanto aos tipos de manutenção descritos
...
Um outro problema que é potencializado pela ausência de cetas funcionalidades
