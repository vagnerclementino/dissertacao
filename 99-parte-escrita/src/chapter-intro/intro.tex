...
ocorrem no ambiente de execução e novos requisitos são solicitados pelo usuário.
Todas estas demandas devem ser solucionadas pelo processo de Manutenção de
Software que se inicia com entrega do sistema. Contudo, alguns autores defendem
que certas atividades, como aquelas relativas à analise da qualidade, começam
bem antes da entrega do produto.
