...
gerência destas solicitações. Esta dissertação apresenta o estudo sobre FGRMs
...
que possibilitem aumento da manutenibilidade do sistema. A ISO
...
uma solicitação de manutenção de qualquer das quatro categorias. Nesta
dissertação adotamos a mesma terminologia com o mesmo significado.
