...
inicial de ferramentas, contudo, apareceram neste resulado final. Tal situação é
decorrente do fato de atribuírmo o maior peso ($w_i = 5$) para aquelas
ferramentas que foram citadas pelos participantes em um campo próprio.  Neste
caso, devido a frquências que estas ferrametnas foram lembradas pelos
