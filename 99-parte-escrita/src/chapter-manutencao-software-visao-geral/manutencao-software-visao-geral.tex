...
código-fonte~\cite{thung2012faults}. Apesar desta quantidade não é fácil
identificar os arquivos onde o problema reside no repositório de código fonte do
sistema. Esta situação realça que localizar a origem de um problema (buggy
files) é uma tarefa árdua~\cite{Thung:2014:BIT:2635868.2661678}.
