...
Complexidade Crescente (Increasing complexity). Segundo a lei da Mudança
Contínua um programa que é utilizado em um ambiente real deve mudar ou se
...
padrão, contudo, pesquisadores e profissionais utilizam o termo como substituto preferido para
manutenção~\cite{Bennett:2000:SME:336512.336534}. Embora exista o entendimento que os processos de manutenção e evolução possuem características distintas, não está no escopo desta dissertação discutir e apresentar tais diferenças. Neste sentido, utilizamos os termos \textit{manter} e
...
usuários. Neste sentido, a atividade de manter software pode ser vista como o desenvolvimento contínuo,
...
As atividade de manutenção pospostas na ISO/IEC 14764 são detalhadas nas tarefas conforme apresentadas
a seguir:
