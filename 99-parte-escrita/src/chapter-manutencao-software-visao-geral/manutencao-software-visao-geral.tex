...
\begin{figure}[htpb] \centering
	\includegraphics[width=0.7\linewidth]{./chapter-manutencao-software-visao-geral/img/ieee-1219-98-processo-manutencao.png}
...
FGRM permitem a definição \textit{campos personalizáveis} para o
