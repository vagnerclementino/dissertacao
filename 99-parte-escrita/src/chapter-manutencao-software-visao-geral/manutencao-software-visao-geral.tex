...
Software~\cite{{ISOIEC-12207-2008}} retrata a manutenção como um dos principais processos no
...
ser corrigido, melhorado ou adaptado~\cite{{159342}}. A ISO/IEC~
9126~-~01~\cite{ISOIEC9126} define a Manutenibilidade como uma característica de
qualidade do processo de Manutenção.
