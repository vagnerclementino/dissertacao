...
De uma maneira geral, podemos definir atividade de manter software como a
...
melhorar o desempenho ou outros atributos com a finalidade de adaptar o software
...
classificação utilizadas durante o texto da dissertação estão descritos a seguir:
...
objetivos de um projeto em adotar uma FGRM para gerenciar suas RMs são os
...
a partir dos dados utilizados~\cite{just2008towards}. Ela envolve a
categorização de um conjunto de cartões em grupos distintos de acordo com um
...
um espectro de funcionalidades para as FGRM que pode ser observado na
...
Nesta categoria as funcionalidades que dão suporte ao processo de trabalho
adotado no desenvolvimento e manutenção de software. Nela estão incluídos
funcionalidade para gerenciamento de tarefas e suporte à múltiplos projetos.
