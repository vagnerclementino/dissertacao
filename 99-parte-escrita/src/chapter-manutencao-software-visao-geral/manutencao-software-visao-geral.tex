...
É possível identificar manter e evoluir como aspectos comuns entre as diferentes
definições para Manutenção de Software. Embora exista o entendimento que os
processos de manutenção e evolução possuem características
distintas~\cite{tripathy2014software}, não está nos objetivos desta dissertação
discutir ou apresentar estas diferenças. Neste sentido, utilizamos os termos
\textit{manter} e \textit{evoluir} de forma intercambiáveis.
...
\todobegin{Rodolfo, você acha que faz sentido o parágrafo a seguir?} Em síntese,
...
A RM no estado \textit{Compromissada} antes que as modificações solicitadas
