...
\begin{figure}[htpb]
    ...
    \caption{Um processo de modificação de uma RM utilizando uma FGRM\@.
        Extraído de~\cite{ihara2009analysis}}
...
equipes estão predominantemente em empresas privadas de software, é o caso de
37 participantes. Com relação ao local de trabalho verificamos ainda que a
segunda posição ficou para empresas que pertencem ao setor governamental, que
tivemos 11 participantes. O restante é composto por 01 profissional que se
...
disponíveis. Neste mesmo sentido, a fórmula que foi utilizada para definir as
