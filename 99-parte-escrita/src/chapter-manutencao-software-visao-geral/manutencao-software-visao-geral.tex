...
produto. Por ser um estado relacionado ao gerenciamento da manutenção, as RMs
...
Por conta do volume das RMs e os diversos desafios relacionados com sua gestão é
...
selecionados; ($ii$) execução, onde os cartões são organizados em grupo
significativos com um título que o descreve; e por fim, ($iii$) análise, no qual
os cartões são sistematizados para formar hierarquias mais abstratas que são
