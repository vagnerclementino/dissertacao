...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Levantamento de Funcionalidades de FGRMs}
...
Para a fonte FA01 foi desenvolvido um robo (web crawler) para coletar as
...
Seção~\ref{sec:caracterizacao_ferramentas}. Após a apresentação de um cardápio
de funcionalidades, os profissionais avaliaram como importantes funções tais
como \textit{Suporte ao Unicode, Múltiplos Projetos, Integração com Sistemas de
    Controle de Versão (VCS Integration)}.
