...
Pela abrangência e dificuldade de caracterização da população nos admitimos a
utilização de uma amostra de conveniência. Neste sentido, utilizamos como
amostra os profissionais que estão envolvidos no projeto de código aberto
...
é possível alcançar essa população, nós admitimos a utilização de uma
...
devido a forma subjetiva que a amostra pode ser escolhida. Uma amostra de
...
utilizada uma amostragem de conveniência implica que as generalizações podem
ser limitadas já que a amostra pode não representar a população. Por outra
lado, utilizamos o arcabouço proposto por de Mello~\cite{de2014towards} visando
