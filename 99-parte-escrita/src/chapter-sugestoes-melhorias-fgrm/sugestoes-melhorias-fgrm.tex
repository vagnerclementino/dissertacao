...
recomendações ordenados pelo nível de aceitação dos participantes.
...
\toprule
\multicolumn{1}{c}{\textbf{Recomendações}} & \textbf{Discordo Fortemente} & \textbf{Discordo} & \textbf{Nem concordo ou discordo} & \textbf{Concordo} & \textbf{Concordo Fortemente} & \textbf{Ranking} \\ \midrule
