...
Uma das atividades relacionada ao processo de manutenção é definir o
desenvolvedor mais apto para determinada RM\@. Durante a sua execução diversos
critérios podem ser utilizados, por exemplo, a prioridade do que foi relatado.
Segundo a nossa proposta, a lista de RMs pode ser ordenada pelo grau de
reputação de quem as redigiu. A partir disso, seria possível atribuir com maior
prioridade RMs de Reportadores com maior grau de reputação. Com base nesta
estratégia, é possível que as RMs com maior relevância sejam analisadas
primeiro. O conceito de relevância pode variar em diferentes projetos.
Contudo, uma RM poderia ser classificada como relevante, caso descreva um
problema que afete um grande número de usuários ou represente uma falha de
...
Conforme descrito anteriormente, durante o processo de atribuição de uma RM
seria possível ordenar uma lista de RMs pelo grau de reputação do
