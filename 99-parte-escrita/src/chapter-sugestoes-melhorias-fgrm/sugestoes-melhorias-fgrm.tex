...
\sugestao{08}{Suporte a tarefas compartilhadas}
...
\begin{itemize}
    ...
    \item Os projetos obtidos devem estar os 10 mais populares que atendem aos
        demais critérios e os melhores classificados pela ordenação via a opção
        ``most stars'', representa o número de usuário do Github que mostraram
        apreciação aos mantenedores do repositório pelo trabalho realizado.
\end{itemize}
...
Fizemos uma investigação utilizando apenas o Github e contendo várias
restrições, as vulnerabilidades?/ameaças a validade? de nossas verificações são
discutidas na seção X
...
(commits), não nos permite afirmar que escolher os projetos mais representativos
