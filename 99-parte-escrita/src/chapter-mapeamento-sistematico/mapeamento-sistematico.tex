...
%Revisão: dom mar 19 11:04:23 BRT 2017
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
A pesquisa visando a melhoria da qualidade da informação fornecida nas RM's tem
...
quantidade de RM's atribuídas e tempo estimado de
...
RM's. Nestes estudos é desenvolvida uma ``rede de colaboração'' que possibilita
...
Os estudos neste tópico visam automatizar o processo de cla\-ssi\-fi\-ca\-ção de
uma RM.  Este tipo de abordagem faz uso da funcionalidade de atribuição de
etiquetas (labels) que é comum  a grande parte das FGRM's (vide
...
Analista de Qualidade, o que pode resultar em classificações
equivocadas.
