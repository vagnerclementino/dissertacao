...
\todobegin{a Tabela 3.1 pode ter, além da coluna com total 286, uma coluna com
	total 64 (mostrando de cada base quantos foram excluídos)}
...
\paragraph{Visualização de RM:} Os estudos classificados neste tópico propõem
...
\todobegin{Discutir melhor os problemas em registrar erros em dispositivos
	móveis}
