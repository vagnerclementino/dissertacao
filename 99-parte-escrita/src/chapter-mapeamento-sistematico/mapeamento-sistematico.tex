...
\begin{itemize}
	...
	\item Critérios de Exclusão
		\begin{itemize}
			\item Livros e literatura cinza (\textit{gray literature})
...
mecanismos de extensão que elas
...
Defeitos (\textit{Bugs Maps}) que mostra a RM e uma ligação dela com outros
...
ferramentas como o \textit{bugMaps}~\cite{hora2012bug} e \textit{In*
    Bug}~\cite{dal2014bug}.
