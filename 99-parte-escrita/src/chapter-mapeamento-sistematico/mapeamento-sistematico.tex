...
%Revisão: ter mar 28 14:12:50 BRT 2017
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\todobegin{a Tabela 3.1 pode ter, além da coluna com total 286, uma coluna com
	total 64 (mostrando de cada base quantos foram excluidos...)}
...
\begin{description}
	\item[Foco na Informação] Estas melhorias focam diretamente na informação
		...
		descrever um defeito (bug), por exemplo, poderia ser motivado a coletar
		mais informações sobre o problema. O sistema poderia verificar a
		validade e consistência do que foi repassado pelo Reportador (vide
...
\paragraph{Visualização de RM:} Os estudos classificados pelo tópico propõem
...
\todobegin{Discutir melhor os problemas em registrar errros em dispositivos
	móveis}
...
Nos estudos recuperados no mapeamento a estimativa de esforço é realizado de
...
\paragraph{Agente de Triagem:} Esta função tem como principal objetivo
...
\paragraph{Chefe da Manutenção} O Chefe da Manutenção têm por responsabilidade
