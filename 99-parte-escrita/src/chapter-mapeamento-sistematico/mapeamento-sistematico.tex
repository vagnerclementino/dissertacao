...
termos de busca tomando como ponto de partida as questões de pesquisa. As
sentenças de busca aplicadas em cada base de pesquisa estão disponíveis no
...
Após uma busca automatizada chegamos a um total de 286 artigos\footnote{A lista
    inicial de artigos pode ser acessada em ~\url{}}. A
Tabela~\ref{tab:estudos-por-base-dados} exibe o total de estudos recuperados
...
em que o título e resumo não eram capazes de caracterizar o trabalho foi
realizada uma leitura completa do texto. O processo descrito resultou em
...
% Nos estudos em que o caráter colaborativo é explorado, verificamos a prevalência
% de métodos de classificação do tipo K-Nearest-Neighbor.
...
% Ainda é possível observar a prevalência de estudos nos tópicos ``Localização de
% RMs Duplicadas'' e ``Atribuição [Triagem] de RM'', o que é natural tendo em
% vista que há um mapeamento entre o papel desempenhado na manutenção com as
% atividades executadas por aquele papel.
