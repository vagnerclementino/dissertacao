...
diretrizes existente na litetura para condução de uma Mapeamento Sistemático, em
aqueles propostos por Kitchenham e outros~\cite{keele2007guidelines}.Um único
investigador seleccionou os estudos candidatos e este mesmo revisor teeve a
responsabilidade de analisar o artigos que seriam incluídos ou excluídos.

O mapeamento realizado neste estudo utilizou o método de aplicação de setenças
de busca nas bases de dados selecionadas para coletar os estudos primários.
Outros estudos utilizam além da estratégia descrita fazem de uso de uma ténica
...
de artigos do mapeamento. Neste sentido, ao usuarmos uma única estrétia podemos
...
lingua inglesa também pode ter havido faltado artigos publicaos em revistas e
...
especial publicados nas principais conferências da área de Engenheria de
Software.

O fato de uma único pesquisador ter sido o responsável pela anaĺise dos estudos
pode siginificar ponto significa que alguns dos dados coletados podem ser
errôneas. O precesso de selelção e validação dos estudos primiários pode levaar
...
Como as bases de dados digitais não funcionam com regras de
...
sentido, a forma que as setenças de busca foram estruturadas podem não ser a
mais otimizada para seleção do maior número de estudos relevantes para o estudo.

\section{Trabalhos Relacionados}
\label{sec:trabalhos_relacionados}

Os autores Kagdi e outros~\cite{kagdi2012assigning} reailzaram uma revisão da
...
funcionalidades ofericidas pelas FGRM possibilitando uma visaõ mais abrangente
...
por lado este trabalho considera as FGRM, sobre o prima de suas funcionalides,
