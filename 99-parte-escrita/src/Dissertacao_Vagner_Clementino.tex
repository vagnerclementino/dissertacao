...
\begin{itemize}
	\item Critérios de Inclusão
		\begin{itemize}
			 ...
			 \item Artigos disponíveis em versão integral
		\end{itemize}
...
de palavras-chaves foi utilizado aquelas informadas pelos autores. Mediante a aplicação do processo foi
...
Triagers are responsible for assigning bugs to the most qualified developers
...
\begin{description}
	\item[Usuário Afetado]:  TODO
	\item[Reportador]: TODO
	\item[Gerente de Requisição de Mudança(Maintenance-request manager)]:
	\item[Agendador(Scheduler)]:
	\item[Desenvolvedor]:
	\item[Analista de Qualidade]:
	\item[Líder da Manutenção(Head of Maintenance)]:
\end{description}
