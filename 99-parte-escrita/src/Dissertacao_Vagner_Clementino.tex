...
\todo[inline]{Incluir figura do esquema de classificação por papéis na manutenção de software}
\todo[inline]{Incluir tabela com os artigos em cada esquema proposto}
\todo[inline]{Incluir no anexo uma tabela demonstrando como as palavras-chaves foram combinadas}
...
Com o objetivo de obter uma visão geral das técnicas que estão sendo utilizadas para implementar as extensões para as FGRM, realizamos a classificação dos estudos através da taxonomia proposta por Canfora e Cerulo\cite{cerulo2004taxonomy}. O esquema de classificação consiste em ..

\todo[inline]{Ler o artigo para melhor entender a taxonomia proposta}
