...
\begin{appendices}
	\chapter{Instrumentos do Mapeamento Sistemático}
	 \label{ch:app-instrumentos-mapeamento}
	  \begin{table}[htb]
	  	\centering
	  	\caption{Setença de Busca por Base de Dados}
	  	\label{tab:setenca-por-base-dados}
	  	\begin{tabular}{ll}
	  		\hline
	  		\textbf{Base de Dados} & \textbf{Sentença de Busca}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \\ \hline
